...
export const info = {
  ...
  options: {
    operation: {
      ...
      default: "convert",
      description: "The TGDF operation to perform. 'convert' transforms input to TGDF format, 'extract' transforms from TGDF to regular format, 'detect' checks if input is TGDF format, and 'ensure' converts to TGDF only if not already in that format."
    },
    deep: {
      type: "boolean",
      default: true,
    ...
    preserveArrays: {
      type: "boolean",
      default: false,
      description: "Whether to preserve JavaScript arrays in the TGDF structure rather than converting them to objects with numeric keys."
    }
  },
  output: {
    type: "object",
